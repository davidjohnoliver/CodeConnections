...
namespace DependsOnThat.Presentation
{
	...
	public class StatisticsReporter
	{
		...
		public IEnumerable<string> WriteGeneralStatistics()
		{
		...
		private IEnumerable<string> GetMostDependencies()
		{
		...
		private IEnumerable<string> GetMostDependents()
		{
		...
		private IEnumerable<string> GetTopClusters()
		{
		...
		public IEnumerable<string> WriteGraphingSpecificStatistics()
		{
