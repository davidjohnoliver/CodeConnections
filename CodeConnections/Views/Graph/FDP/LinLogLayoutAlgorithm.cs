...
namespace CodeConnections.Views.Graph.FDP
{
		...
		where TGraph : IBidirectionalGraph<TVertex, TEdge>
	{
		...
		*/
		...
		/// 
		/// // GTr: Builds a QuadTree (like OctTree, only in 2D).
		/// </summary>
		private QuadTree BuildQuadTree()
		{
			//a minimális és maximális pozíció számítása
			// GTr: calculation of minimum and maximum position
			...
			// GTr: adding nodes with non-zero repulsionWeight to QuadTree.
